...
- **Color Palette:**
  ...
  - **Text Colors:**
    - `##11182` (Dark Charcoal - Main headings and text)
...
- **Hero Image:**
  - [View Hero Image (Homepage Cover)](https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=2787&auto=format&fit=crop) _(Placeholder representing a book reading visual for the main landing page)_
...
_Example: `GET /books/84` retrieves "Frankenstein"._
